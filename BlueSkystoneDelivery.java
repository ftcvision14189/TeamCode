...
@Autonomous public class BlueSkystoneDelivery extends LinearOpMode {
    ...
    // Set servo max/min
    private float SERVO_MIN = 0.1f;
    private float SERVO_MAX = 0.7f;
    ...
    public void runOpMode() {
        ...
        if (skystonePos == 1) {
            moveStraight(0.5f, 0.2); // Move to stones
            clawServo.setPosition(SERVO_MIN); // Grab Skystone
            moveStraight(-0.1f, 0.2); // Move back slightly
            strafe(-0.5f, 0.2 ); // Strafe under Skybridge
